...
<body>
	<div class="menu_bar">
		...
		<form action="InsertarLocal.php" class="Formulario1" name="Formulario_R" method="POST">
			<div class="contenedorF">
				<div class="input_group">
					<input type="text" id="local" name="local" autocomplete="off" required onkeypress="return sololetras(event)" onpaste="return false"/>
					<label class="lbl" for="local">Local:</label>
				</div>
